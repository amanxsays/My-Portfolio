...
assets/images/profile.jpg          Hero photo (compressed for web)
...
`assets/images/profile.jpg` is wired into the hero section already. To swap
it, replace that file with a new image of the same name (ideally already
resized to ~1000px wide to keep the page fast — large phone-camera photos
can be several MB unresized).
